...
The current phase is **Phase 1 — Board Core**. Build only the vertical slice defined in `docs/harness/product-scope.md`. Authentication, persistence, realtime, file processing, PDF export, and AI are later phases unless a task explicitly promotes them.
